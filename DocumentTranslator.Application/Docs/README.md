...
подключает модуль presentation `DocumentTranslator.Presentation/Effects`:
...
#include "DocumentTranslator.Presentation/Effects/Effects.h"
...
Этот тип объявлен в `DocumentTranslator.Presentation/Effects/Effects.h` в namespace `mobileclock::resources::effects`.
...
регистрирует эффекты из DocumentTranslator.Presentation/Effects и анимации приложения из
...
DocumentTranslator.Presentation/Effects/Effects.cpp. Шейдер волны находится там же в
